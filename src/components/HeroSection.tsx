...
export default function HeroSection() {
  ...
  return (
    <section className="max-w-7xl mx-auto flex flex-col md:flex-col lg:flex-row gap-8 items-start px-4 py-10 min-h-[300px] max-sm:px-4 max-sm:py-6">
      {/* 左欄：Hero 圖 & 文案 */}
      <div className="flex-1 w-full md:w-full max-sm:w-full max-[700px]:w-full">
        <div className="relative w-full h-[400px] md:h-auto bg-[url('/backbroad.jpg')] bg-cover bg-center max-sm:h-[300px] max-[700px]:h-[350px] w-full md:w-full max-w-full mx-auto object-contain">
          {/* 疊加內容 */}
      ...
      {/* 右欄：熱門科目 */}
      <div className="w-full md:w-[420px] max-w-full md:mx-auto md:mt-4 order-last md:order-none">
        <div className="bg-white shadow-md rounded-lg p-6 h-[400px] md:h-auto max-sm:h-auto max-sm:p-4 max-[700px]:h-auto max-[700px]:p-5">
