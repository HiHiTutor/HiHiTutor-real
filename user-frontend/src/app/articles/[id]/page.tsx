  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-lg shadow">
      ...
      <div className="text-sm text-gray-500 mb-2">
        ✍️ 作者：<a href={`/tutors/${typeof article.authorId === 'object' ? article.authorId._id : article.authorId}`} className="text-blue-600 hover:underline">{article.author}</a>　🕒 發佈時間：{article.date || '未知'}
      </div>
      <div className="mb-4">
